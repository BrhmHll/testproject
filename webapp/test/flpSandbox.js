		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comvesaconstestproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvesaconstestproject-display": {
								"semanticObject": "comvesaconstestproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.vesacons.testproject",
									"url": sap.ui.require.toUrl("com/vesacons/testproject")
								}
							}
						}
					}
